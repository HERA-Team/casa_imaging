...
# IO Arguments
a.add_argument("--cleanspace", default=True, help="Clean directory of image stem namespace before proceeding.")
...
a.add_argument('--flag_autos', default=True, help="flag autocorrelations in data.")
a.add_argument("--export_fits", default=True, help="Export all output CASA images to FITS.")
