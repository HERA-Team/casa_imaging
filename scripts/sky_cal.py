...
a.add_argument('--gain_spw', default='0:100~924', type=str, help="Spectral window selection for gaincal routine.")
a.add_argument("--bp_spw", default='0:100~924', type=str, help="Spectral window selection for bandpass routine.")
